...
Spring boot microservices with Java 8, MySQL, eureka, zuul, feign, ribbon, zipkin, sleuth
...
1. Java 8
2. JPA Mysql
3. Spring Boot Actuator (Optional)
...
![Alt text](asset/eureka_server.PNG?raw=true "Eureka Server")
